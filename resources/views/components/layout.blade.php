...
<head>
    ...
    <title>{{ $title ?? 'Laravel for PHP developers HBG' }}</title>
    <!-- Fonts -->
    <link rel="stylesheet" href="https://rsms.me/inter/inter.css">
    <link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet">
    <meta name="author" content="Hector Blanco">
</head>
<body class="h-full">
<div class="min-h-full">
                    ...
                    <div class="ml-3 relative">
                        <div>
                            <button type="button" class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                ...
                                <img class="h-8 w-8 rounded-full" src="https://static.displate.com/280x392/displate/2022-07-04/4bef9ef083df4e7e6cfb4ec95e64cd05_6423162f053439845f3a9996588082f7.jpg" alt="">
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex items-center bg-purple-600 text-white text-sm font-bold px-4 py-3 mb-8 rounded-md" role="alert">
                <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.432 0c1.34 0 2.01.912 2.01 1.957 0 1.305-1.164 2.512-2.679 2.512-1.269 0-2.009-.75-1.974-1.99C9.789 1.436 10.67 0 12.432 0zM8.309 20c-1.058 0-1.833-.652-1.093-3.524l1.214-5.092c.211-.814.246-1.141 0-1.141-.317 0-1.689.562-2.502 1.117l-.528-.88c2.572-2.186 5.531-3.467 6.801-3.467 1.057 0 1.233 1.273.705 3.23l-1.391 5.352c-.246.945-.141 1.271.106 1.271.317 0 1.357-.392 2.379-1.207l.6.814C12.098 19.02 9.365 20 8.309 20z"/></svg>
                <p>Welcome. You are checking a test webpage created by hcrbg</p>
        </div>
    {{ $slot }}
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="mt-12 border-t border-gray-200 pt-8">
            <p class="text-base text-gray-400 xl:text-center">
                &copy; 2023 Workflow with Laravel. All rights reserved.
            </p>
        </div>
    </div>
</footer>
